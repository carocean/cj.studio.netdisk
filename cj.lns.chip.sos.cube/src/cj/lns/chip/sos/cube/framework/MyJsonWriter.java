...
public class MyJsonWriter extends  AbstractBsonWriter {
	  ...
	  private final Writer writer;
	     ...
	     */
	    public MyJsonWriter(final Writer writer) {
	     ...
	     */
	    public MyJsonWriter(final Writer writer, final JsonWriterSettings settings) {
	        super(settings);
...
//	        }
	    ...
	    protected void doWriteDateTime(final long value) {
	        try {
	        	/*
	        	 * 日期型现在是对象，将来也要改为值，参照doWriterInt64方法
	        	 */
	            switch (settings.getOutputMode()) {
	                case STRICT:
	                    writeStartDocument();
